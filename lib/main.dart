...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void launchGit() async {
    final Uri urll = Uri(scheme: "https", host: "github.com", path:"/Danila97871/komponovka");
    if (!await launchUrl(urll, mode: LaunchMode.externalApplication)) {
      throw "Error";
    }
  }
          ...
          children: [
            ...
            Padding(
                ...
                child: Align(
                  ...
                  child: OutlinedButton(onPressed: launchGit, child: const Text('перейти на git')),
                )
            ),
            Padding(
            ...
            Padding(
                ...
                child: Align(
                  ...
                  child: Image.asset("images/kot.jpg"),
                )
            ),
          ],
        )
